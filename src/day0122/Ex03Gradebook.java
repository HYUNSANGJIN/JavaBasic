 ...
 * 입력할수 있어야 한다.
 * 
 * 또한 , 사용자가 메뉴에서 2라고 입력할때 마다 입력된 정보를
 * 출력할 수 있어야 한다.
 * 
 * 만약, 사용자가 메뉴에서 3이라고 입력하면 프로그램은 종료한다.
 */
public class Ex03Gradebook {
    static final int SUBJECT_SIZE = 3;   // 평균을 위한 과목 수
    static final int OPTION_INSERT = 1;  // 입력 옵션값
    static final int OPTION_PRINT = 2;   // 출력 옵션값
    static final int OPTION_END = 3;     // 종료 옵션값
    static final int MAX_SCORE = 100;    // 최대 점수값
